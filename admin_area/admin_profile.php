...
<?php 
    ...
    if(isset($_GET['user_profile'])){
        ...
        $user_country = $row_user['admin_pays'];
        
        $user_about = $row_user['admin_about'];
        
        $user_contact = $row_user['admin_contacte'];
        
        $user_job = $row_user['admin_travail'];
...
if(isset($_POST['update'])){
    ...
    $update_user = "update admins set admin_nom='$user_name',admin_email='$user_email',admin_pass='$user_pass',admin_pays='$user_country',admin_contacte='$user_contact',admin_travail='$user_job',admin_about='$user_about',admin_image='$user_image' where admin_id='$user_id'";
