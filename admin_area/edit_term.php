...
if(isset($_GET['edit_term'])){
    ...
    $get_term = "select * from terme where terme_id='$edit_id'";
    $run_term = mysqli_query($con,$get_term);
    $row_term = mysqli_fetch_array($run_term);
    $term_id = $row_term['terme_id'];
    $term_title = $row_term['terme_titre'];
    $term_desc = $row_term['terme_description'];
    $term_link = $row_term['terme_link'];
...
if(isset($_POST['update'])){
    ...
    $update_term = "update terme set terme_titre='$term_title',	terme_link='$term_link',terme_description='$term_desc' where terme_id='$term_id'";
