...
<?php 
    ...
    if(isset($_GET['edit_product'])){
        ...
        $p_title = $row_edit['produit_titre'];
        
        $p_cat = $row_edit['souscat_id'];
        
        $cat = $row_edit['categorie_id'];

        $m_id = $row_edit['fabricant_id'];
        
        $p_image1 = $row_edit['produit_img1'];
        
        $p_image2 = $row_edit['produit_img2'];
        
        $p_image3 = $row_edit['produit_img3'];
        
        $p_price = $row_edit['produit_prix'];
        
        $p_keywords = $row_edit['produit_motscles'];
        
        $p_desc = $row_edit['produit_description'];
        
    }
        
        $get_manufacturer = "select * from fabricant where 	fabricant_id='$m_id'";
        ...
        $get_p_cat = "select * from sous_categories where souscat_id='$p_cat'";
        ...
        $get_cat = "select * from categories where categorie_id='$cat'";
...
if(isset($_POST['update'])){
    ...
    if(is_uploaded_file($_FILES['file']['tmp_name'])){
        ...
        $update_product = "update produit set souscat_id='$product_cat',categorie_id='$cat',fabricant_id='$manufacturer_id',date=NOW(),produit_titre='$product_title',produit_img1='$product_img1',produit_img2='$product_img2',produit_img3='$product_img3',produit_motscles='$product_keywords',produit_description='$product_desc',produit_prix='$product_price' where id_produit='$p_id'";
        ...
        $update_product = "update produit set souscat_id='$product_cat',categorie_id='$cat',fabricant_id='$manufacturer_id',date=NOW(),produit_titre='$product_title',produit_motscles='$product_keywords',produit_description='$product_desc',produit_prix='$product_price' where id_produit='$p_id'";
