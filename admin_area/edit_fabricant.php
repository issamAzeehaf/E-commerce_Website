...
<?php  
        ...
        if(isset($_GET['edit_manufacturer'])){
            ...
            $get_manufacturer = "select * from fabricant where 	fabricant_id='$edit_manufacturer'";
            $run_manufacturer = mysqli_query($con,$get_manufacturer);
            $row_manufacturer = mysqli_fetch_array($run_manufacturer);

            $m_id = $row_manufacturer['fabricant_id'];
            $m_title = $row_manufacturer['fabricant_titre'];
            $m_top = $row_manufacturer['fabricant_top'];
            $m_image = $row_manufacturer['fabricant_image'];
...
<?php  
    ...
    if(isset($_POST['update'])){
        ...
        if(is_uploaded_file($_FILES['manufacturer_image']['tmp_name'])){
            ...
            $update_manufacturer = "update fabricant set fabricant_titre='$manufacturer_name',fabricant_top='$manufacturer_top',fabricant_image='$manufacturer_image'where 	fabricant_id='$m_id'" ;
            ...
            $update_manufacturer = "update fabricant set fabricant_titre='$manufacturer_name',fabricant_top='$manufacturer_top' where fabricant_id='$m_id'" ;
