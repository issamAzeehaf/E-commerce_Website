...
<?php 
    ...
    if(isset($_GET['edit_cat'])){
        ...
        $edit_cat_query = "select * from categories where categorie_id='$edit_cat_id'";
        
        $run_edit = mysqli_query($con,$edit_cat_query);
        
        $row_edit = mysqli_fetch_array($run_edit);
        
        $cat_id = $row_edit['categorie_id'];
        
        $cat_title = $row_edit['categorie_titre'];
        
        $cat_top = $row_edit['categorie_top'];
        
        $cat_image = $row_edit['categorie_image'];
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              if(is_uploaded_file($_FILES['cat_image']['tmp_name'])){
                ...
                $update_cat = "update categories set categorie_titre='$cat_title',categorie_top='$cat_top',categorie_image='$cat_image' where 	categorie_id='$cat_id'";
