...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into admins (admin_nom,admin_email,admin_pass,admin_pays,admin_contacte,admin_travail,admin_image,admin_about) values ('$user_name','$user_email','$user_pass','$user_country','$user_contact','$user_job','$user_image','$user_about')";
