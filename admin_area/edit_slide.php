...
<?php 
    ...
    if(isset($_GET['edit_slide'])){
        ...
        $slide_name = $row_edit_slide['slide_nom'];
...
<?php  
    ...
    if(isset($_POST['update'])){
        ...
        $update_slide = "update slide set slide_nom='$slide_name',slide_url='$slide_url',slide_image='$slide_image' where slide_id='$slide_id'";
