                    ...
                    <table class="table table-hover table-striped table-bordered"><!-- table table-hover table-striped table-bordered begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                $get_order = "select * from commande order by 1 DESC LIMIT 0,5";
                                ...
                                while($row_order=mysqli_fetch_array($run_order)){
                                    ...
                                    $qty = $row_order['Quantite'];
                                    
                                    $size = $row_order['Taille'];
                                    
                                    $order_status = $row_order['statut'];
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        $get_customer = "select * from client where 	client_id='$c_id'";
