        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            ...
            <div class="panel-body"><!-- panel-body begin -->
                ...
                <?php 
                    ...
                    $get_terms = "select * from terme";
        
                    $run_terms = mysqli_query($con,$get_terms);
        
                    while($run_terms_section=mysqli_fetch_array($run_terms)){
                        
                        $term_id = $run_terms_section['terme_id'];
                        
                        $term_title = $run_terms_section['terme_titre'];
                        
                        $term_desc = substr($run_terms_section['terme_description'],0,400);
