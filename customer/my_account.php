   ...
   <div id="top"><!-- Top Begin -->
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
               ...
               echo @$totalitm; ?> Items In Your Cart | Total Price: <?php
              ...
              $total =0;
               ...
               $sql2 = "select Quantite,montant from commande where client_id='$client_id' and statut='pending'";

               $result2 = mysqli_query($con,$sql2);

               while($run2=mysqli_fetch_row($result2)){
                      $pro_qty = $run2[0];
                       $pro_prix = $run2[1];
