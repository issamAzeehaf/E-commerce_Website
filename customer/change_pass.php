...
if(isset($_POST['submit'])){
    ...
    $sel_c_old_pass = "select * from client where client_pass='$c_old_pass'";
    ...
    $update_c_pass = "update client set client_pass='$c_new_pass' where client_email='$c_email'";
